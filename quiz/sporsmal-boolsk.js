...
const QUESTIONS = [
  ...
  {
    cat: 'boolsk',
    q: 'Hva er resultatet av dobbel negasjon — (A̅)̅? (regel 1)',
    opts: [
      'A̅ — signalet forblir invertert',
      'A — to inverteringer opphever hverandre',
      '0 — signalet tilbakestilles til lav',
      '1 — signalet settes til høy'
    ],
    correct: 1,
    explain: 'Dobbel negasjon (regel 1): (A̅)̅ = A. Inverteres et signal to ganger kommer du tilbake til det originale signalet.'
  },
  ...
  {
    cat: 'boolsk',
    q: 'Hva er A + A̅? (regel 4 — komplementlov for OR)',
    opts: ['0', 'A̅', 'A', '1'],
    correct: 3,
    explain: 'Komplementlov for OR (regel 4): A + A̅ = 1. En variabel OR-et med sin komplement gir alltid 1 — én av dem er alltid sann.'
  },
  ...
  {
    cat: 'boolsk',
    q: 'Hva er A · A̅? (regel 8 — komplementlov for AND)',
    opts: ['1', 'A', 'A̅', '0'],
    correct: 3,
    explain: 'Komplementlov for AND (regel 8): A · A̅ = 0. En variabel AND-et med sin komplement gir alltid 0 — én av dem er alltid lav.'
  },
  ...
  {
    cat: 'boolsk',
    q: 'Hva er A + A̅·B forenklet? (regel 18)',
    opts: ['A·B', 'A̅ + B', 'A', 'A + B'],
    correct: 3,
    explain: 'Regel 18: A + A̅·B = A + B. A̅-faktoren i det andre leddet kan fjernes fordi A allerede er til stede i OR.'
  },

  {
    cat: 'boolsk',
    q: 'De Morgans første lov — hva er A̅·̅B̅? (regel 19)',
    opts: [
      'Ā · B̄',
      'A + B',
      'A̅ + B̅',
    ...
    img: `<svg viewBox="0 0 280 90" xmlns="http://www.w3.org/2000/svg"><rect width="280" height="90" fill="#161927" rx="8"/><text x="140" y="16" fill="#7b82a8" font-size="10" text-anchor="middle" font-family="system-ui,sans-serif">De Morgans lover — to ekvivalente former</text><rect x="14" y="26" width="110" height="34" fill="#1e2235" rx="6" stroke="#5c7cfa" stroke-width="1.5"/><text x="69" y="47" fill="#5c7cfa" font-size="13" text-anchor="middle" font-family="monospace">A̅·̅B̅ = ?</text><text x="136" y="47" fill="#7b82a8" font-size="20" text-anchor="middle">→</text><rect x="156" y="26" width="110" height="34" fill="#1e2235" rx="6" stroke="#7b82a8" stroke-width="1" stroke-dasharray="4,3"/><text x="211" y="47" fill="#7b82a8" font-size="13" text-anchor="middle" font-family="monospace">?</text><text x="140" y="78" fill="#7b82a8" font-size="9" text-anchor="middle" font-family="system-ui,sans-serif">Hvilken av alternativene fyller inn i høyre boks?</text></svg>`,
    correct: 2,
    explain: 'De Morgans 1. lov (regel 19): A̅·̅B̅ = A̅ + B̅. En NAND-port kan realiseres som inverterte innganger med en OR-port. Sentralt verktøy for kretssimplifikasjon.'
  },

  {
    cat: 'boolsk',
    q: 'De Morgans andre lov — hva er A̅+̅B̅? (regel 20)',
    opts: [
      'A̅ + B̅',
      'A̅ · B̅',
      'A̅·̅B̅',
    ...
    correct: 1,
    explain: 'De Morgans 2. lov (regel 20): A̅+̅B̅ = A̅ · B̅. En NOR-port kan realiseres som inverterte innganger med en AND-port. Speilet versjon av den første De Morgan-loven.'
  },
