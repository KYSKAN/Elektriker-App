const QUIZ_META = {
  ...
  description: '40 spørsmål om vekststrategier (Ansoff), konkurransestrategier, markedsplan, markedsmiksen 5P og distribusjon.',
  cats: {
    ...
    distribusjon: { label: 'Distribusjon og kommunikasjon', color: '#ec4899' },
  }
};
...
const QUESTIONS = [
  ...
  },
  {
    ...
    bins: [
      { id: 'eks', label: 'Eksklusiv distribusjon', color: '#8b5cf6' },
      { id: 'sel', label: 'Selektiv distribusjon',  color: '#3b82f6' },
      { id: 'int', label: 'Intensiv distribusjon',  color: '#10b981' },
    ],
    items: [
      { text: 'Rolex selges kun i utvalgte prestisjejuvelerforretninger',          bin: 'eks' },
      { text: 'Brus og sjokolade finnes i alle kiosker og dagligvarebutikker',     bin: 'int' },
      { text: 'Nike-sko selges gjennom godkjente sportsforretninger',              bin: 'sel' },
      { text: 'Ferrari har én offisiell forhandler per storbyregion',              bin: 'eks' },
      { text: 'Tyggegummi distribueres til bensinstasjoner og matbutikker',        bin: 'int' },
      { text: 'Merkevare-kosmetikk selges kun i sertifiserte parfymerier',         bin: 'sel' },
    ],
