...
const QUESTIONS = [
  ...
  },
  {
    ...
    opts: [
      'Salgsinntekter − Varekostnad − Lønnskostnader − Avskrivninger − Andre driftskostnader = Driftsresultat for perioden',
  ...
  },
  {
    ...
    opts: [
      ...
      'Totalt varekjøp inkludert mva, beregnet og fordelt likt over alle månedene i hele budsjettperioden',
      'Gjennomsnittlig varebeholdning multiplisert med den estimerte omløpshastigheten for varelageret',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'Øke prisene på alle produkter og tjenester og dermed styrke inntjeningsevnen og likviditeten på kortere sikt',
      ...
      'Avvikle bedriften midlertidig og stenge virksomheten inntil likviditetsreserven igjen er positiv',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      'Avvik der kostnadene er høyere enn budsjettert, noe som indikerer økt aktivitetsnivå og høyere etterspørsel',
      ...
      'Avvik over 5 %, siden de er store nok til å ha en målbar og vesentlig positiv effekt på årsresultatet',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      'De er i stor grad uavhengige – ulikt formål og innhold gjør at de to budsjettene er lite relevante og sammenlignbare med hverandre',
      ...
      'Likviditetsbudsjettet er alltid beregnet som resultatbudsjettet fratrukket avskrivninger, skattekostnad og vedtatt utbytte',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      ...
      'Resultatbudsjettet: lønnskostnader periodisert; likviditetsbudsjettet: faktiske utbetalinger inkl. arbeidsgiveravgift og ferielønn terminvis',
    ],
    correct: 3,
  ...
  },
  {
    ...
    opts: [
      'En fremtidsrettet vurdering av forventede priser, lønnsutvikling og markedsforhold',
