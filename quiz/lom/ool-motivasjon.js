...
const QUESTIONS = [
  ...
  },
  {
    ...
    opts: [
      'Anerkjennelse – å oppnå respekt og status fra omgivelsene',
      'Trygghet – å ha stabile rammer og forutsigbar inntekt',
      'Selvrealisering – å utnytte sitt fulle potensial',
      'Tilhørighet – å inngå i nære og meningsfylte relasjoner',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      ...
      'Hygienefaktorer øker motivasjonen direkte; motivasjonsfaktorer forebygger bare mistrivsel',
      'Begge faktorene påvirker motivasjon, men virker på ulike tidspunkt i arbeidsprosessen',
  ...
  },
  {
    ...
    opts: [
      'Prioriter høy lønn og gode sosiale goder – dette motiverer mest',
      'Sørg for at hygienefaktorer er akseptable, og jobb aktivt med motivasjonsfaktorer',
      'Bruk tydelig struktur og direkte styring for å sikre produktivitet',
  ...
  },
  {
    ...
    opts: [
      'Lederen mener ansatte er selvgående, kreative og liker å ta ansvar',
      'Lederen mener ansatte er late, unngår ansvar og må kontrolleres strengt',
      'Lederen delegerer oppgaver og er opptatt av ansattes autonomi',
      'Lederen legger vekt på indre motivasjon og meningsfylte arbeidsoppgaver',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      'En amerikansk økonom som utviklet SMART-målmodellen for bedrifter',
      'En japansk ledelsesguru som innførte LEAN-prinsippene i europeisk industri',
  ...
  },
  {
    ...
    opts: [
      ...
      'Å motta lønn og bonus som gjenspeiler egne prestasjoner',
  ...
  },
  {
    ...
    opts: [
      ...
      'At kompetansen omfordeles mellom avdelinger etter skiftende behov',
      'At bedriften sender ansatte på kurs for å bygge opp ny kompetanse',
