...
const QUESTIONS = [
  ...
  },
  {
    ...
    opts: [
      'Ansvar, faglig vekst og direkte anerkjennelse fra leder',
      'Lønn, fysiske arbeidsforhold og lederstil',
      'Mestring, interessante arbeidsoppgaver og karriereutvikling',
      'Selvrealisering, samarbeid og mulighet for faglig utvikling',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      'Lønn, pensjon og tydelige bedriftsretningslinjer',
      'Anerkjennelse, ansvar, interessante oppgaver og faglig vekst',
      'Arbeidsforhold, kollegafellesskap og administrativ støtte',
      'Jobbsikkerhet, kontorstandard og sosiale goder',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      'Ansatte er passive og trenger tydelig styring fra leder',
      'Ansatte jobber primært for lønn og unngår ekstra forpliktelser',
      'Ansatte yter best under strukturert kontroll og klare sanksjoner',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'Motivasjon som drives av lønn, bonus og karrieremuligheter',
      'Motivasjon som skyldes kollegenes forventninger og gruppepresset',
      'Motivasjon som oppstår ved frykt for negative konsekvenser',
  ...
  },
  {
    ...
    opts: [
      'Oppgaven er godt betalt og gir klare karrieremessige fordeler',
      'Oppgaven er rutinepreget og krever lite selvstendig vurdering',
      'Oppgaven er interessant, meningsfull og gir mestringsfølelse',
      'Oppgaven utføres i konkurranse, noe som øker engasjementet',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      ...
      'Formell utdanning, sertifikater og dokumenterte kvalifikasjoner',
      'Antall år med praktisk erfaring i en bestemt bransje eller stilling',
      'Evnen til å samarbeide, kommunisere og løse konflikter med kolleger',
    ],
    correct: 0,
