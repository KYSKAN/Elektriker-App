const QUIZ_META = {
  ...
  description: '38 spørsmål om økonomistyringens grunnlag, regnskapstyper, kostnadsbegreper, avskrivninger og lønnskostnader.',
  cats: {
    ...
    lonnskostnader:      { label: 'Lønnskostnader', color: '#ec4899' },
  }
};
