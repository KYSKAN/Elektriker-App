const QUIZ_META = {
  ...
  description: '33 spørsmål om økonomistyringens grunnlag, regnskapstyper, kostnadsbegreper, regnskapsprinsipper og avskrivninger.',
  cats: {
...
const QUESTIONS = [
  ...
  },
  {
    ...
    bins: [
      { id: 'fast', label: 'Fast kostnad',     color: '#3b82f6' },
      { id: 'var',  label: 'Variabel kostnad', color: '#10b981' },
    ],
    items: [
      { text: 'Husleie for produksjonslokalet',          bin: 'fast' },
      { text: 'Råvarer per produsert enhet',             bin: 'var' },
      { text: 'Administrasjonslønn til daglig leder',    bin: 'fast' },
      { text: 'Emballasjekostnader per produkt',         bin: 'var' },
      { text: 'Forsikringspremie på bedriftens maskiner', bin: 'fast' },
      { text: 'Provisjon til selgere per avsluttet salg', bin: 'var' },
    ],
  ...
  },
  {
    ...
    bins: [
      { id: 'dir',   label: 'Direkte kostnader',   color: '#8b5cf6' },
      { id: 'indir', label: 'Indirekte kostnader', color: '#f59e0b' },
    ],
    items: [
      { text: 'Trelast brukt til å bygge et bestemt skap',        bin: 'dir' },
      { text: 'Strømkostnad for hele produksjonshallen',          bin: 'indir' },
      { text: 'Direkte arbeidstid på et spesifikt oppdrag',       bin: 'dir' },
      { text: 'Regnskapsførerhonorar til ekstern konsulent',      bin: 'indir' },
      { text: 'Maling brukt på et konkret malingsprosjekt',       bin: 'dir' },
      { text: 'Administrasjonslønn som ikke knyttes til én ordre', bin: 'indir' },
    ],
