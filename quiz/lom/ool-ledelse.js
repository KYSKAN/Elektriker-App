...
const QUESTIONS = [
  {
    ...
    opts: [
      'Fastsetter mål og retning alene, men forklarer begrunnelsen',
      'Involverer medarbeiderne i beslutningsprosessen, men beholder det endelige ansvaret',
      'Delegerer beslutningsansvar til teamet og trekker seg tilbake fra prosessen',
  ...
  },
  {
    ...
    opts: [
      'Lederen setter klare rammer og følger opp resultatene tett',
      'Lederen involverer teamet i beslutninger og tar ansvar for utfallet',
  ...
  },
  {
    ...
    opts: [
      'En direktiv metode der lederen angir løsning og forventer gjennomføring',
      'En prosess der lederen hjelper medarbeideren til å finne egne løsninger gjennom åpne spørsmål og refleksjon',
      'En strukturert evalueringssamtale basert på fastsatte mål og måltall',
  ...
  },
  {
    ...
    opts: [
      ...
      'Å orientere medarbeideren om organisasjonens strategi og prioriteringer',
      'Å gjennomgå lønns- og arbeidsvilkår i henhold til tariffavtalen',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      'Alle ansatte inngår i tverrfaglige team og rapporterer til prosjektleder',
  ...
  },
  {
    ...
    opts: [
      'En varig struktur med faste fagavdelinger og stabilt lederskap',
  ...
  },
  {
    ...
    opts: [
      ...
      'Den formelle ivaretar de menneskelige behovene; den uformelle sikrer effektiv ressursstyring og resultatkontroll',
      'Den uformelle organisasjonen er nedfelt i stillingsbeskrivelser; den formelle oppstår gjennom sosiale nettverk',
  ...
  },
  {
    ...
    opts: [
      'Et sterkt internt press om hurtig omstilling, drevet frem av konkurranse og teknologiskifte',
      'En konstruktiv og løsningsorientert holdning til endring som styrker innovasjonsevnen',
  ...
  },
  {
    ...
    opts: [
      ...
      'Endringsmål, ressursallokering, tidshorisont, risikotoleranse og kompetanseutvikling',
      'Visjon, lederforankring, kommunikasjon, kulturell beredskap og strukturell tilpasning',
      'Planlegging, pilotgjennomføring, evaluering, korrigering og bred implementering',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      ...
      'Intern rekruttering er raskere og gir sterkere lojalitet, men krever mer opplæring og tilpasning',
      'Ekstern rekruttering gir lavere kostnader og raskere onboarding enn intern rekruttering',
      'Intern rekruttering forutsetter formell utlysning og ekstern kunngjøring av stillingen',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'Delegering er å fordele rutineoppgaver mellom medarbeidere; forutsetning: oppgavene må være klart beskrevet',
      'Delegering er en midlertidig overføring av arbeid; forutsetning: lederen kan hente tilbake oppgavene ved behov',
