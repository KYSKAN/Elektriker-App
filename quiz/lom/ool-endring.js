...
const QUESTIONS = [
  ...
  },
  {
    ...
    opts: [
      ...
      'Et strukturert opplegg for å presentere endringens resultater, gevinster og læringspunkter for styret og eiere etter gjennomføring',
      'Et dokument som beskriver nye roller, ansvarsfordeling, kommunikasjonskanaler og rutiner i den reviderte organisasjonen',
  ...
  },
  {
    ...
    opts: [
      ...
      'Å forankre den nye atferden og de nye rutinene som den permanente standarden etter at endringen er gjennomført',
      'Å skape motivasjon og erkjennelse av at endring er nødvendig – løsne opp status quo',
      'Å systematisk kartlegge resultater, analysere avvik og justere kursen basert på tilbakemeldinger fra ansatte',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      'En finansmodell for å beregne avkastning, lønnsomhet og netto nåverdi ved investeringer i prosessforbedring',
      'En teknisk tilnærming for å forenkle produktdesign, standardisere deler og redusere totalt antall komponenter',
  ...
  },
  {
    ...
    opts: [
      'Å digitalisere informasjonsflyt og knytte alle avdelinger og team sammen gjennom felles integrerte IT-plattformer',
      'Å kartlegge og dokumentere organisasjonens delsystemer, tydeliggjøre ansvarsområder og definere grensesnitt mellom enheter',
  ...
  },
  {
    ...
    opts: [
      ...
      'At ansatte jobber målrettet mot toppresultater, benchmarker seg mot bransjen og konkurrerer om de beste prestasjonene',
