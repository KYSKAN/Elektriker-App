...
const QUESTIONS = [
  ...
  },
  {
    ...
    bins: [
      { id: 'lonn', label: 'Lønnsomhet', color: '#8b5cf6' },
      { id: 'sol',  label: 'Soliditet',  color: '#3b82f6' },
      { id: 'lik',  label: 'Likviditet', color: '#10b981' },
    ],
    items: [
      { text: 'Totalkapitalrentabilitet (TKR)',   bin: 'lonn' },
      { text: 'Egenkapitalprosent',               bin: 'sol' },
      { text: 'Likviditetsgrad 1 (LG1)',           bin: 'lik' },
      { text: 'Driftsmargin',                     bin: 'lonn' },
      { text: 'Gjeldsgrad',                       bin: 'sol' },
      { text: 'Varelagerets omløpshastighet',     bin: 'lik' },
      { text: 'Egenkapitalrentabilitet (EKR)',    bin: 'lonn' },
      { text: 'Finansieringsgrad 1',              bin: 'sol' },
    ],
