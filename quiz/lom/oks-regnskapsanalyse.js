...
const QUESTIONS = [
  {
    ...
    opts: [
      'Å beregne skatten bedriften skylder ved årets slutt',
      ...
      'Å dokumentere verdien av eiendeler for forsikringsformål',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      'Resultatmargin = Bruttofortjeneste / Salgsinntekter × 100; bør minst være lik bransjenorm',
  ...
  },
  {
    ...
    opts: [
      'Bruttofortjeneste = Salgsinntekter − Alle driftskostnader; BFP = BF / Driftskostnader × 100',
  ...
  },
  {
    ...
    opts: [
      'Avanse = Bruttofortjeneste / Salgsinntekter × 100 – det er et annet navn for BFP',
      'Avanse = Bruttofortjeneste / Varekostnaden × 100 – beregnes av innkjøpsprisen, ikke salgsprisen',
      'Avanse = Salgsinntekter / Varekostnad × 100 – viser salgsvolum per krone innkjøp',
  ...
  },
  {
    ...
    opts: [
      ...
      'TKR = Salgsinntekter / Gjennomsnittlig totalkapital × 100; krav: over 1',
      'TKR = Egenkapital / Gjennomsnittlig totalkapital × 100; krav: over 35%',
    ],
    correct: 1,
  ...
  },
  {
    ...
    opts: [
      ...
      'EKR = TKR × Gjeldsgrad – viser effekten av gearing på eierens avkastning',
  ...
  },
  {
    ...
    opts: [
      'Bedriftens evne til å betale kortsiktig gjeld ved forfall',
      ...
      'Bedriftens evne til å hente inn ekstern finansiering ved behov',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      ...
      'Gjeldsgrad = Gjeld / Totalkapital × 100; norm: under 65%',
      'Gjeldsgrad = Langsiktig gjeld / Egenkapital; krav: under 3',
  ...
  },
  {
    ...
    opts: [
      ...
      'Antall dager kunden har på seg til å betale ifølge kontrakten',
      'Kredittsalg / Gjennomsnittlige kundefordringer – viser omsetningshastighet på fordringer',
      'Andel av kunder som betaler etter forfall; = Forfalte fordringer / Totale fordringer × 100',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'Redusere antall ansatte og midlertidig utsette leverandørbetalinger',
      'Ta opp mer lån for å finansiere investeringer og vekst',
  ...
  },
  {
    ...
    opts: [
      ...
      'Øke varelager for å sikre leveranser og unngå utsalg',
      'Dele ut mer utbytte og øke egenkapitalen via emisjon',
      'Investere i ny produksjonskapasitet finansiert med kortsiktig gjeld',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      ...
      'Bedre soliditet fører automatisk til økt lønnsomhet via lavere rentekostnader',
  ...
  },
  {
    ...
    opts: [
      'Begge verdier er innenfor normal variasjon – ingen umiddelbar bekymring',
      ...
      'Begge verdier er for høye – bedriften binder for mye kapital i omløpsmidler',
    ],
    correct: 2,
  ...
  },
  {
    ...
    opts: [
      'En metode der bedriften reduserer varelageret ved å selge ut med rabatt',
      'En finansieringsform der leverandøren gir lenger betalingsfrist mot en avgift',
      'Å selge kundefordringer til et factoringselskap mot umiddelbar betaling (minus en avgift) – gir raskere innbetaling',
      'En ordning der banken overtar innkrevingen mot at bedriften får kassekreditt',
    ],
    correct: 2,
