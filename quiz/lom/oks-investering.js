...
const QUESTIONS = [
  // Q1 – correct=1 (98 tegn). Gjør opt[0] lengre enn riktig (103 tegn).
  {
    ...
    opts: [
      ...
      'Innskudd i bank, sparekonto eller pengemarkedsfond med kjent rente og forutsigbar, begrenset markedsrisiko',
      'Kjøp av patenter, varemerker og andre immaterielle rettigheter for bruk i virksomheten og dens drift',
    ],
    correct: 1,
  ...
  // Q2 – correct=1 (129 tegn). Gjør opt[3] lengre enn riktig (135 tegn).
  {
    ...
    opts: [
      'Den renten banken krever for å innvilge og tilby lån til gjennomføring av det aktuelle prosjektet',
      'Den minimumavkastning en investering må gi for å være akseptabel – risikofri rente, risikotillegg og inflasjonstillegg',
      'Gjennomsnittsavkastningen bedriften har oppnådd basert på de siste tre regnskapsårene',
  ...
  // Q4 – correct=3 (58 tegn). Gjør opt[0] lengre (68 tegn).
  {
    ...
    opts: [
      ...
      'At priser stiger over tid og reduserer kjøpekraften gradvis',
      'At penger i banken tjener renter og vokser over tid gjennom renters rente',
  ...
  // Q5 – correct=1 (132 tegn). Gjør opt[3] lengre enn riktig (138 tegn).
  {
    ...
    opts: [
      'En metode som beregner og uttrykker avkastningen i prosent av det totalt investerte beløpet',
      'En metode som beregner tilbakebetalingstiden: TBT = Investeringsutgift / Årlig innbetalingsoverskudd',
      'En metode som omregner og diskonterer fremtidige kontantstrømmer ned til dagens pengeverdi',
  ...
  // Q6 – correct=1 (80 tegn). Gjør opt[0] lengre enn riktig (87 tegn).
  {
    ...
    opts: [
      ...
      'Den er ikke egnet for prosjekter med engangsutbetaling, slik som ombyggingsprosjekter',
      'Den forutsetter at kalkulasjonsrenten er kjent på forhånd og holdes fast i beregningen',
    ],
    correct: 1,
  ...
  // Q7 – correct=0 (90 tegn), opt[1]=96. Already good – correct is NOT longest. Leave as is.
  {
    ...
    opts: [
      ...
      'En metode som beregner årlig avkastning; gjennomfør hvis snitt > avkastningskrav',
  ...
  // Q9 – correct=1 (118 tegn). Gjør opt[0] lengre enn riktig (126 tegn).
  {
    ...
    opts: [
      ...
      'En liste over alle prosjekter med positiv nåverdi, rangert etter størrelse på verdiskapingen',
      'En tabell som viser alle estimerte kontantstrømmer for hvert enkelt år i prosjektets levetid',
    ],
    correct: 1,
  ...
  // Q10 – correct=0 (128 tegn). Gjør opt[1] lengre enn riktig (136 tegn).
  {
    ...
    opts: [
      ...
      'Prosjekter som ikke kan gjennomføres i det samme regnskapsåret grunnet kapasitets- eller budsjettbegrensninger',
      'Prosjekter som krever formell godkjenning fra ulike avdelinger og ledernivåer i bedriften',
    ],
    correct: 0,
  ...
  // Q11 – correct=2 (174 tegn). Gjør opt[3] lengre enn riktig (182 tegn).
  {
    ...
    opts: [
      ...
      'IRR måler prosentavkastning uten hensyn til størrelse – et lite prosjekt kan gi lavere fortjeneste enn et stort prosjekt',
  ...
  // Q12 – correct=3 (46 tegn), opt[1]=66. Already good – correct is NOT longest. Leave as is.
  {
    ...
    opts: [
      ...
      'Velg prosjektet med høyest internrente blant de lønnsomme',
  ...
  // Q14 – correct=2 (121 tegn). Gjør opt[0] lengre enn riktig (130 tegn).
  {
    ...
    opts: [
      ...
      'En systematisk vurdering av om prosjektet tåler konjunktursvingninger og markedsendringer over tid',
      'Man endrer én og én forutsetning i kalkylen for å se konsekvensene for nåverdien – vurderer usikkerhet i kontantstrømmene',
      'En analyse av kundenes betalingsvilje og prissensitivitet ved ulike prisnivåer og markedssegmenter',
    ],
    correct: 2,
  ...
  // Q15 – correct=3 (133 tegn). Gjør opt[1] lengre enn riktig (142 tegn).
  {
    ...
    opts: [
      'En kalkulatorisk kostnad som ennå ikke har generert noen direkte betaling eller kontantutgang',
      ...
      'En skjult eller indirekte kostnad som ikke fremkommer tydelig direkte i den ordinære kalkylen',
      'En allerede pådratt kostnad som ikke kan gjenvinnes – irrelevant for fremtiden fordi den påløper uansett hva man velger',
    ],
    correct: 3,
  ...
  // Q16 – correct=0 (127 tegn). Gjør opt[2] lengre enn riktig (136 tegn).
  {
    ...
    opts: [
      'Kapital investert i kundefordringer, varelager og råvarer – kapital som ikke gir avkastning og representerer en kostnad',
      'Kapital plassert i aksjer, obligasjoner og andre finansielle instrumenter i kapitalmarkedet',
      ...
      'Egenkapitalen aksjonærene har skutt inn i selskapet gjennom tegning av aksjer ved stiftelse eller emisjon',
    ],
    correct: 0,
  ...
  // Q18 – correct=3 (151 tegn). La riktig være lengst, men juster feil noe.
  {
    ...
    opts: [
      ...
      'Å kreve forhåndsbetaling fra samtlige kunder, uavhengig av etablert kundeforhold, kreditthistorikk og betalingshistorikk',
      'Å avvise kunder med dårlig betalingshistorikk og høy kredittrisiko gjennom systematisk og streng kredittvurdering',
      'Å selge kundefordringer til et factoringselskap mot umiddelbar betaling (minus avgift) – reduserer kapitalbinding og gir kredittforsikring',
    ],
    correct: 3,
  ...
  // Q19 – correct=0 (137 tegn). Gjør opt[2] lengre enn riktig (145 tegn).
  {
    ...
    opts: [
      'Defensiv = unngå tap via purrerutiner og kredittvurdering; offensiv = bruke kredittpolitikk proaktivt som konkurransefortrinn',
      'Defensiv = sette korte betalingsfrister til alle kunder; offensiv = sette strategisk lange betalingsfrister',
      ...
      'Defensiv = streng fakturakontroll og purreoppfølging; offensiv = aktiv inkassobruk ved betalingsforsinkelse',
    ],
    correct: 0,
  ...
  // Q20 – correct=2 (126 tegn). Gjør opt[0] lengre enn riktig (134 tegn).
  {
    ...
    opts: [
      ...
      'Kun leiekostnad for lagerlokalet og lagerbygget beregnet per kvadratmeter per år',
      'Svinn, ukurans, renter på bundet kapital, forsikring og servicekostnader – oppgis som % av lagerverdi',
      'Kun lønnskostnader til lagerarbeidere, trucksjåfører og øvrig lagerpersonell i virksomheten',
    ],
    correct: 2,
  ...
  // Q21 – correct=3 (125 tegn). La riktig være lengst.
  {
    ...
    opts: [
      ...
      'Antall leveranser bedriften gjennomfører til en bestemt kunde eller kundegruppe per kalenderår',
      'Kundetilfredshetsscore og NPS-verdi basert på systematisk spørreundersøkelse etter levering',
      'Andelen av etterspørselen som kan leveres direkte fra lager – høyere servicenivå krever mer kapital bundet i lager',
    ],
    correct: 3,
  ...
  // Q22 – correct=0 (107 tegn). Gjør opt[3] lengre enn riktig (115 tegn).
  {
    ...
    opts: [
      ...
      'Det bestillingstidspunktet som isolert gir lavest mulig lagringskostnad per enhet over tid',
      'Det volumet som sikrer at bedriften aldri risikerer å gå tom for varer under normalt driftsnivå',
      'Det volumet som utløser høyest kvantumsrabatt fra leverandøren og dermed lavest innkjøpspris per enhet',
    ],
    correct: 0,
  ...
  // Q23 – correct=2 (119 tegn). Gjør opt[1] lengre enn riktig (128 tegn).
  {
    ...
    opts: [
      'En modell for å vurdere og rangere ansattes prestasjonsnivå som grunnlag for lønnsfastsettelse',
      ...
      'En budsjetteringsmetode der de tre største og mest dominerende kostnadspostene analyseres grundig',
    ],
    correct: 2,
  ...
  // Q24 – correct=3 (139 tegn). La riktig være lengst.
  {
    ...
    opts: [
      ...
      'ABC-analyse brukes utelukkende til å rangere og evaluere leverandører etter leveringspålitelighet og kvalitet',
      'C-varer prioriteres høyest og gis mest oppmerksomhet fordi de utgjør flest unike varenummer i hele produktsortimentet',
      'A-varer (høy verdi): tett oppfølging og hyppige tellinger; B-varer: middels; C-varer (lav verdi): enklere rutiner og sikkerhetslagre',
    ],
    correct: 3,
  ...
  // Q27 – correct=3 (120 tegn). Gjør opt[1] lengre enn riktig (129 tegn).
  {
    ...
    opts: [
      'Investering A – kortere TBT indikerer alltid høyere lønnsomhet og er det eneste relevante beslutningskriteriet',
      'Begge er like gode – TBT-metoden er tilstrekkelig som beslutningsgrunnlag når prosjektenes levetid og størrelse er like',
      'Investering B – større kontantstrøm etter år 3 er alltid det eneste avgjørende og korrekte kriteriet',
  ...
  // Q28 – correct=2 (145 tegn). La riktig være lengst.
  {
    ...
    opts: [
      'Metoder for å automatisere og effektivisere produksjonslinjer ved hjelp av avansert robotteknologi',
      'IT-systemer for sanntidsovervåking og styring av lagerbeholdning, innkjøpsordrer og leverandørstatus',
      'JIT: levere materialer akkurat når de trengs – minimerer lager; LEAN: eliminere sløsing som overproduksjon og unødvendig lager',
  ...
  // Q29 – correct=3 (104 tegn). Gjør opt[1] lengre enn riktig (114 tegn).
  {
    ...
    opts: [
      'Styrke egenkapitalen gjennom kapitalutvidelse og aktivt nedbetale langsiktig gjeld over tid',
      'Ansette flere selgere, øke markedsføringsbudsjettet og investere i kundebearbeiding og CRM-systemer',
      'Utvide varelageret for å sikre leveringsevne og øke kassekredittrammen hos banken',
