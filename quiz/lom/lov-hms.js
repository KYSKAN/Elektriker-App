const QUIZ_META = {
  ...
  description: '40 spørsmål om arbeidsmiljøloven, ferieloven, tariffavtaler, HMS-regelverk og andre sentrale lover.',
  cats: {
    ...
    andre_lover: { label: 'Andre sentrale lover', color: '#ec4899' },
  }
};
...
const QUESTIONS = [
  ...
  },
  {
    ...
    bins: [
      { id: 'mfl',   label: 'Markedsføringsloven',    color: '#8b5cf6' },
      { id: 'gdpr',  label: 'GDPR / personvernloven', color: '#ef4444' },
      { id: 'diskr', label: 'Diskrimineringsloven',    color: '#10b981' },
      { id: 'angre', label: 'Angrerettloven',           color: '#f59e0b' },
    ],
    items: [
      { text: 'Forbyr villedende og aggressiv markedspraksis',                   bin: 'mfl' },
      { text: 'Krever rettslig grunnlag for behandling av personopplysninger',    bin: 'gdpr' },
      { text: 'Forbyr diskriminering på grunnlag av kjønn og etnisitet',          bin: 'diskr' },
      { text: '14 dagers angrefrist ved fjernsalg og netthandel',                bin: 'angre' },
      { text: 'Forbyr ulovlig direktemarkedsføring per e-post (spam)',           bin: 'mfl' },
      { text: 'Gir registrerte rett til innsyn i egne lagrede personopplysninger', bin: 'gdpr' },
    ],
