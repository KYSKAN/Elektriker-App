...
const QUESTIONS = [
  ...
  },
  {
    ...
    opts: [
      ...
      'Kun i offentlig sektor og kommunale virksomheter',
  ...
  },
  {
    ...
    opts: [
      'AMU er et lønnsforhandlingsorgan som fastsetter lønn og tillegg, og er påkrevd i alle virksomheter med minst 30 ansatte',
      'AMU arbeider med HMS og samarbeid om arbeidsmiljø; påkrevd fra 50 ansatte',
      'AMU er et rådgivende organ for arbeidstid og skiftordninger, og er påkrevd fra 20 ansatte etter AML § 7-2',
  ...
  },
  {
    ...
    opts: [
      '21 virkedager (3 uker) – dette er minimumsstandarden etter EU-direktivet om arbeidstid',
      '25 virkedager (4 uker + 1 dag)',
      '24 virkedager (4 uker) – tilsvarer standard i mange europeiske land og gjelder ved tariffavtale',
  ...
  },
  {
    ...
    opts: [
      ...
      'At tariffavtalen ikke kan sies opp eller endres i tariffperioden, men kun reforhandles formelt ved avtalens utløpsdato',
      'At tariffavtalen utelukkende er rettslig bindende for de arbeidstakere som er registrerte medlemmer av en fagforening',
  ...
  },
  {
    ...
    opts: [
      ...
      'Tariffavtaler er ufravikelige og direkte gjeldende for samtlige bedrifter i bransjen, fullstendig uavhengig av om de er medlemmer i en arbeidsgiverorganisasjon',
      'Individuelle arbeidsavtaler kan etter gjeldende rett lovlig gi svakere vilkår enn det tariffavtalen fastsetter, dersom arbeidstaker skriftlig samtykker til dette',
      'Det er i praksis ingen rettslig eller avtalemessig forskjell mellom tariffavtale og individuell avtale – begge regulerer nøyaktig de samme forholdene',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'En oppsigelsesform der arbeidstaker fritas fra møteplikt, men fortsatt mottar full lønn gjennom hele oppsigelsestiden',
      'Lønnet permisjon som gis for faglig oppdatering og etter- eller videreutdanning i henhold til tariffavtalens bestemmelser',
  ...
  },
  {
    ...
    opts: [
      'Alle former for sykefravær fullstendig uavhengig av årsak, diagnose eller tilknytning til arbeid, for alle innbyggere over 18 år',
      'Full lønn uten noe beløpstak i opptil 2 sammenhengende år, for alle yrkesaktive arbeidstakere og selvstendig næringsdrivende',
      'Utelukkende godkjente arbeidsulykker og yrkessykdommer som oppfyller kravene etter Folketrygdloven § 13-3 og medisinsk dokumentasjon',
  ...
  },
  {
    ...
    opts: [
      ...
      'Å regulere internrevisjon av regnskap og økonomistyring i virksomheter',
  ...
  },
  {
    ...
    opts: [
      'En detaljert plan for sykefraværsoppfølging, tilrettelegging og oppfølging av sykemeldte arbeidstakere på arbeidsplassen',
      'En plan for systematisk HMS-opplæring, kompetansekartlegging og sertifisering av alle ansatte i virksomheten',
      'En overordnet strategiplan for helse, fordeling av ansvar og arbeidsoppgaver mellom ledelse og ansatte i virksomheten',
  ...
  },
  {
    ...
    opts: [
      ...
      'En juridisk gjennomgang av arbeidsavtalens gyldighet, tariffmessige krav og personalmessige konsekvenser ved kontraktsbrudd',
      'En detaljert rapport som utarbeides ETTER en arbeidsulykke for å kartlegge årsaksforhold og hindre gjentakelse',
      'En kvantitativ statistisk analyse av sykefravær, nær-uhell og ulykker over en definert tidsperiode i virksomheten',
    ],
    correct: 0,
  ...
  },
  {
    ...
    opts: [
      'Et kort som dokumenterer gjennomført HMS-opplæring, godkjente vernekurs og sertifikater for farlig arbeid',
      'Et elektronisk tilgangskort som åpner adgangspunkter og gir differensiert adgang til ulike sikkerhetssoner på anlegget',
      'Et kort med detaljert oversikt over ansattes lønns-, pensjons- og arbeidsvilkår i henhold til gjeldende tariffavtale',
  ...
  },
  {
    ...
    opts: [
      'Verneombudet, som etter AML er gitt formelt ansvar for å planlegge, koordinere og gjennomføre all HMS-opplæring for sine kolleger',
      'Arbeidstakeren selv, som selvstendig må sørge for å dokumentere, fornye og holde sin samlede HMS-kompetanse til enhver tid oppdatert',
      'Arbeidsgiver, som har plikt til å gi nødvendig opplæring, øvelse og instruksjon',
      'Fagforeningen, som gjennom tariffforhandlinger fremforhandler og nedfeller opplæringsrettigheter i gjeldende tariffavtale for bransjen',
    ],
    correct: 2,
