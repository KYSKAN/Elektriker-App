...
const QUESTIONS = [
...

  {
    ...
    img: `<svg viewBox="0 0 280 80" xmlns="http://www.w3.org/2000/svg"><rect width="280" height="80" fill="#161927" rx="8"/><text x="140" y="15" fill="#7b82a8" font-size="10" text-anchor="middle" font-family="system-ui,sans-serif">Dette er XOR-uttrykket A⊕B</text><rect x="14" y="24" width="120" height="46" fill="#1e2235" rx="6" stroke="#5c7cfa" stroke-width="1.5"/><text x="74" y="40" fill="#5c7cfa" font-size="12" text-anchor="middle" font-family="monospace">A=1, B=0</text><text x="74" y="58" fill="#7b82a8" font-size="10" text-anchor="middle" font-family="monospace"><tspan text-decoration="overline">A</tspan>·B + A·<tspan text-decoration="overline">B</tspan></text><text x="140" y="50" fill="#7b82a8" font-size="18" text-anchor="middle">→</text><rect x="156" y="24" width="110" height="46" fill="#1e2235" rx="6" stroke="#7b82a8" stroke-width="1" stroke-dasharray="4,3"/><text x="211" y="40" fill="#7b82a8" font-size="11" text-anchor="middle" font-family="monospace">0·0 + 1·1</text><text x="211" y="58" fill="#7b82a8" font-size="11" text-anchor="middle" font-family="monospace">= 0 + 1 = ?</text></svg>`,
    opts: ['0', '1', 'A', 'B'],
    correct: 1,
